# To run this program change the collection name : "sentiment_trump_CA" to the name of collection you want to run in the following lines:

#l_allTweets = l_client.twitter_db.sentiment_trump_CA.find()
#l_posTweets = l_client.twitter_db.sentiment_trump_CA.find({"sentiment" : "positive"})
#l_negTweets = l_client.twitter_db.sentiment_trump_CA.find({"sentiment" : "negative"})
#l_neuTweets = l_client.twitter_db.sentiment_trump_CA.find({"sentiment" : "neutral"})
